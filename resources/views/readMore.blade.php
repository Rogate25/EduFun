...
<body>
    <nav class="navbar navbar-expand-lg bg-white">
      ...
      <div class="rm container mx-auto py-12">
        <h2>{{ $article->category->courseName }}</h2>
        <img src="{{ asset('images/' . $article->image) }}" alt="Article Image" class="img-fluid mb-3">
        <br>{{ $article->published_at}} | 
        {{ $article->writer ? $article->writer->name : 'Unknown' }}</p>
